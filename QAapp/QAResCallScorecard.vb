...
Public Class QAResCallScorecard
    ...
    Private Sub QAResCallScorecard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub Store()
        ...
        Try
            ...
            Dim SQL As String = "INSERT INTO [QAMainDB] ([SR], [ContactID], [CType],[QA-Agent],[QA-Team],[QA-ContactDate],[QA-OrderID],[QA-Date],[QA-Comments],[QA-Opp],[CI-Name],[CI-Account],[CI-Company],[CI-Phone],[CI-Email],[Rev-Date],[Rev-Manager],[Rev-Comments],[Dis-Score],[Dis-Name],[Dis-Notes],[Dis-AppComments],[One-1],[One-2],[One-3],[One-1Note],[One-2Note],[One-3Note],[Two-1],[Two-1Note],[Three-1],[Three-2],[Three-3],[Three-4],[Three-5],[Three-6],[Three-7],[Three-8],[Three-1Note],[Three-2Note],[Three-3Note],[Three-4Note],[Three-5Note],[Three-6Note],[Three-7Note],[Three-8Note],[Four-1],[Four-2],[Four-3],[Four-1Note],[Four-2Note],[Four-3Note],[Five-1],[Five-2],[Five-1Note],[Five-2Note],[Six-1],[Six-2],[Six-3],[Six-1Note],[Six-2Note],[Six-3Note],[Seven-1],[Seven-2],[Seven-3],[Seven-4],[Seven-5],[Seven-6],[Seven-1Note],[Seven-2Note],[Seven-3Note],[Seven-4Note],[Seven-5Note],[Seven-6Note],[QAScore],[AutoFail],[Auditor]) Values ( ?, ?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
            ...
            Using cmd As New OleDbCommand(SQL, con)
                ...
                cmd.Parameters.AddWithValue("@p75", lblQAScore1.Text)


                If cboAutoFail.Checked Then

                    cmd.Parameters.AddWithValue("@p76", cboAF.Text)

                Else

                    cmd.Parameters.AddWithValue("@p76", "N/a")

                End If


                cmd.Parameters.AddWithValue("@p77", lblQAauditor1.Text)
    ...
    Public Sub QAExcell()
        ...
        Try
            ...
            '  Dim oBook As Object = oExcel.Workbooks.Open("C:\Users\playe\Desktop\QA\ScoreCard Excell\ResCallSc.xlsx")

            '' P Drive

            '   Dim oBook As Object = oExcel.Workbooks.Open("P:\SPC\QA\ResCallSc.xlsx")


            '' Dynamic

            Dim oBook As Object = oExcel.Workbooks.Open(lbldrive2.Text & "\Users\" & lblSCRN.Text & "\Desktop\QA1\ResCallSc.xlsx")




            Dim oSheet As Object = oBook.Worksheets("ResCallSc")  'or oBook.Worksheets("SheetName")
            ...
            oSheet.Range("C117").Value = "" & cbo3_8.Text
            ...
            oSheet.Range("C25").Value = "" & Six


            oSheet.Range("C26").Value = "" & cbo6_1.Text
            oSheet.Range("C27").Value = "" & cbo6_2.Text
            oSheet.Range("C28").Value = "" & cbo6_3.Text


            oSheet.Range("D26").Value = "" & txt6_1.Text
            oSheet.Range("D27").Value = "" & txt6_2.Text
            oSheet.Range("D28").Value = "" & txt6_3.Text

            oSheet.Range("C29").Value = "" & seven


            oSheet.Range("C30").Value = "" & cbo7_1.Text
            oSheet.Range("C31").Value = "" & cbo7_2.Text
            oSheet.Range("C32").Value = "" & cbo7_3.Text
            oSheet.Range("C33").Value = "" & cbo7_4.Text
            oSheet.Range("C34").Value = "" & cbo7_5.Text
            oSheet.Range("C35").Value = "" & cbo7_6.Text


            oSheet.Range("D20").Value = "" & txt7_1.Text
            oSheet.Range("D31").Value = "" & txt7_2.Text
            oSheet.Range("D32").Value = "" & txt7_3.Text
            oSheet.Range("D33").Value = "" & txt7_4.Text
            oSheet.Range("D34").Value = "" & txt7_5.Text
            oSheet.Range("D35").Value = "" & txt7_6.Text


            oSheet.Range("A53").Value = txtQACom.Text
            oSheet.Range("A67").Value = txtQAAOO.Text





            oSheet.Range("C36").Value = lblQAScore1.Text




            oSheet.Range("B38").Value = lblSRNumber1.Text
            oSheet.Range("B39").Value = lblContactID1.Text
            oSheet.Range("B40").Value = lblContactType1.Text
            oSheet.Range("B41").Value = "" & lblAgentName1.Text
            oSheet.Range("B42").Value = "" & lblAgentTeam1.Text
            oSheet.Range("B43").Value = txtgDatebox.Text
            oSheet.Range("B44").Value = txtgorderid.Text
            oSheet.Range("B45").Value = "" & txtgnamebox.Text
            oSheet.Range("B46").Value = "" & txtgemail.Text
            oSheet.Range("B47").Value = "" & txtgphone.Text
            oSheet.Range("B48").Value = "" & txtgcompany.Text
            oSheet.Range("B49").Value = "" & txtgacc.Text
            oSheet.Range("B50").Value = "" & lblQAauditor1.Text
            oSheet.Range("B51").Value = "" & lblDate1.Text
        ...
        Try
            ...
            Else
                ...
                If lblQAScore1.Visible = True Then
                    ...
                    MsgBox("This audit was already saved, please refresh and start a new one", MessageBoxButtons.RetryCancel)
    ...
    Private Sub QAResCallScorecard_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
