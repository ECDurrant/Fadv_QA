...
Public Class QAWOTCInboundRev
    ...
    Public Sub save()
        ...
        Try
            ...
            Dim SQL As String = "INSERT INTO [QAMainDB] ([ContactID],[EMID],[RegID],[AHT],[CType],[QA_Agent],[QA_Team],[QA_ContactDate],[QA_OrderID],[QA_Date],[QA_Comments],[QA_Opp],[CI_Name],[CI_Account],[CI_Company],[CI_Phone],[CI_Email],[Rev_Date],[Rev_Manager],[Rev_Comments],[Dis_Score],[Dis_Name],[Dis_Notes],[Dis_AppComments],[One_1],[One_2],[One_3],[One_1Note],[One_2Note],[One_3Note],[Two_1],[Two_1Note],[Three_1],[Three_2],[Three_3],[Three_4],[Three_5],[Three_6],[Three_7],[Three_1Note],[Three_2Note],[Three_3Note],[Three_4Note],[Three_5Note],[Three_6Note],[Three_7Note],[Four_1],[Four_2],[Four_3],[Four_1Note],[Four_2Note],[Four_3Note],[Five_1],[Five_2],[Five_1Note],[Five_2Note],[Six_1],[Six_1Note],[Seven_1],[Seven_2],[Seven_3],[Seven_1Note],[Seven_2Note],[Seven_3Note],[QAScore],[Autofail],[Auditor],[Supervisor],[Week_Number],[EditedQA],[TCX_Score],[1_1],[1_2],[1_3],[2_1],[3_1],[3_2],[3_3],[3_4],[3_5],[3_6],[3_7],[4_1],[4_2],[4_3],[5_1],[5_2],[6_1],[7_1],[7_2],[7_3],[Month],[DisputedQA],[PendingDisputeID],[SRType],[MainSupervisor],[CSATScore],[CSATQ1],[CSATQ2],[CSATQ3],[CSATQ4],[CSATQ5],[CSATQ6],[CallerType],[Dis_TCXScore])  Values (@ContactID,@EMID,@RegID,@AHT, @CType, @QA_Agent, @QA_Team, @QA_ContactDate, @QA_OrderID, @QA_Date, @QA_Comments, @QA_Opp, @CI_Name, @CI_Account, @CI_Company, @CI_Phone, @CI_Email, @Rev_Date, @Rev_Manager, @Rev_Comments, @Dis_Score, @Dis_Name, @Dis_Notes, @Dis_AppComments, @One_1, @One_2, @One_3, @One_1Note, @One_2Note, @One_3Note, @Two_1, @Two_1Note, @Three_1, @Three_2, @Three_3, @Three_4, @Three_5, @Three_6, @Three_7,@Three_1Note, @Three_2Note, @Three_3Note, @Three_4Note, @Three_5Note, @Three_6Note, @Three_7Note, @Four_1, @Four_2, @Four_3, @Four_1Note, @Four_2Note, @Four_3Note, @Five_1, @Five_2, @Five_1Note, @Five_2Note, @Six_1,@Six_1Note, @Seven_1, @Seven_2, @Seven_3, @Seven_1Note, @Seven_2Note, @Seven_3Note,@QAScore, @Autofail, @Auditor, @Supervisor, @Week_Number, @EditedQA, @TCX_Score,@1_1,@1_2,@1_3,@2_1,@3_1,@3_2,@3_3,@3_4,@3_5,@3_6,@3_7,@4_1,@4_2,@4_3,@5_1,@5_2,@6_1,@7_1,@7_2,@7_3,@Month,@DisputedQA,@PendingDisputeID,@SRType,@MainSupervisor,@CSATScore,@CSATQ1,@CSATQ2,@CSATQ3,@CSATQ4,@CSATQ5,@CSATQ6,@CallerType,@Dis_TCXScore)"
            ...
            Using cmd As New SqlCommand(SQL, con)
                ...
                cmd.Parameters.AddWithValue("@CallerType", txtCallerType.Text)
    ...
    Public Sub save2()
        ...
        Try
            ...
            Dim SQL As String = "INSERT INTO [QAMainDB] ([ContactID],[EMID],[RegID],[AHT],[CType],[QA_Agent],[QA_Team],[QA_ContactDate],[QA_OrderID],[QA_Date],[QA_Comments],[QA_Opp],[CI_Name],[CI_Account],[CI_Company],[CI_Phone],[CI_Email],[Rev_Date],[Rev_Manager],[Rev_Comments],[Dis_Score],[Dis_TCXScore],[Dis_Name],[Dis_Notes],[Dis_AppComments],[One_1],[One_2],[One_3],[One_1Note],[One_2Note],[One_3Note],[Two_1],[Two_1Note],[Three_1],[Three_2],[Three_3],[Three_4],[Three_5],[Three_6],[Three_7],[Three_1Note],[Three_2Note],[Three_3Note],[Three_4Note],[Three_5Note],[Three_6Note],[Three_7Note],[Four_1],[Four_2],[Four_3],[Four_1Note],[Four_2Note],[Four_3Note],[Five_1],[Five_2],[Five_1Note],[Five_2Note],[Six_1],[Six_1Note],[Seven_1],[Seven_2],[Seven_3],[Seven_1Note],[Seven_2Note],[Seven_3Note],[QAScore],[Autofail],[Auditor],[Supervisor],[Week_Number],[EditedQA],[TCX_Score],[1_1],[1_2],[1_3],[2_1],[3_1],[3_2],[3_3],[3_4],[3_5],[3_6],[3_7],[4_1],[4_2],[4_3],[5_1],[5_2],[6_1],[7_1],[7_2],[7_3],[Month],[DisputedQA],[PendingDisputeID],[SRType],[MainSupervisor],[CSATScore],[CSATQ1],[CSATQ2],[CSATQ3],[CSATQ4],[CSATQ5],[CSATQ6],[CallerType],[1_1b],[1_2b],[1_3b],[2_1b],[3_1b],[3_2b],[3_3b],[3_4b],[3_5b],[3_6b],[3_7b],[4_1b],[4_2b],[4_3b],[5_1b],[5_2b],[6_1b],[7_1b],[7_2b],[7_3b])  Values (@ContactID,@EMID,@RegID,@AHT, @CType, @QA_Agent, @QA_Team, @QA_ContactDate, @QA_OrderID, @QA_Date, @QA_Comments, @QA_Opp, @CI_Name, @CI_Account, @CI_Company, @CI_Phone, @CI_Email, @Rev_Date, @Rev_Manager, @Rev_Comments, @Dis_Score, @Dis_TCXScore, @Dis_Name, @Dis_Notes, @Dis_AppComments, @One_1, @One_2, @One_3, @One_1Note, @One_2Note, @One_3Note, @Two_1, @Two_1Note, @Three_1, @Three_2, @Three_3, @Three_4, @Three_5, @Three_6, @Three_7,@Three_1Note, @Three_2Note, @Three_3Note, @Three_4Note, @Three_5Note, @Three_6Note, @Three_7Note, @Four_1, @Four_2, @Four_3, @Four_1Note, @Four_2Note, @Four_3Note, @Five_1, @Five_2, @Five_1Note, @Five_2Note, @Six_1,@Six_1Note, @Seven_1, @Seven_2, @Seven_3, @Seven_1Note, @Seven_2Note, @Seven_3Note,@QAScore, @Autofail, @Auditor, @Supervisor, @Week_Number, @EditedQA, @TCX_Score,@1_1,@1_2,@1_3,@2_1,@3_1,@3_2,@3_3,@3_4,@3_5,@3_6,@3_7,@4_1,@4_2,@4_3,@5_1,@5_2,@6_1,@7_1,@7_2,@7_3,@Month,@DisputedQA,@PendingDisputeID,@SRType,@MainSupervisor,@CSATScore,@CSATQ1,@CSATQ2,@CSATQ3,@CSATQ4,@CSATQ5,@CSATQ6,@CallerType,@1_1b,@1_2b,@1_3b,@2_1b,@3_1b,@3_2b,@3_3b,@3_4b,@3_5b,@3_6b,@3_7b,@4_1b,@4_2b,@4_3b,@5_1b,@5_2,@6_1b,@7_1b,@7_2b,@7_3b)"
            ...
            Using cmd As New SqlCommand(SQL, con)
                ...
                cmd.Parameters.AddWithValue("@1_1b", txt1_1b.Text)
                cmd.Parameters.AddWithValue("@1_2b", txt1_2b.Text)
                cmd.Parameters.AddWithValue("@1_3b", txt1_3b.Text)


                cmd.Parameters.AddWithValue("@2_1b", txt2_1b.Text)

                cmd.Parameters.AddWithValue("@3_1b", txt3_1b.Text)
                cmd.Parameters.AddWithValue("@3_2b", txt3_2b.Text)
                cmd.Parameters.AddWithValue("@3_3b", txt3_3b.Text)
                cmd.Parameters.AddWithValue("@3_4b", txt3_4b.Text)
                cmd.Parameters.AddWithValue("@3_5b", txt3_5b.Text)
                cmd.Parameters.AddWithValue("@3_6b", txt3_6b.Text)
                cmd.Parameters.AddWithValue("@3_7b", txt3_7b.Text)


                cmd.Parameters.AddWithValue("@4_1b", txt4_1b.Text)
                cmd.Parameters.AddWithValue("@4_2b", txt4_2b.Text)
                cmd.Parameters.AddWithValue("@4_3b", txt4_3b.Text)

                cmd.Parameters.AddWithValue("@5_1b", txt5_1b.Text)
                cmd.Parameters.AddWithValue("@5_2b", txt5_2b.Text)

                cmd.Parameters.AddWithValue("@6_1b", txt6_1b.Text)


                cmd.Parameters.AddWithValue("@7_1b", txt7_1b.Text)
                cmd.Parameters.AddWithValue("@7_2b", txt7_2b.Text)
                cmd.Parameters.AddWithValue("@7_3b", txt7_3b.Text)
    ...
    Public Sub save3()
        ...
        Try
            ...
            Dim SQL As String = "INSERT INTO [QAMainDB] ([ContactID],[EMID],[RegID],[AHT],[CType],[QA_Agent],[QA_Team],[QA_ContactDate],[QA_OrderID],[QA_Date],[QA_Comments],[QA_Opp],[CI_Name],[CI_Account],[CI_Company],[CI_Phone],[CI_Email],[Rev_Date],[Rev_Manager],[Rev_Comments],[Dis_Score],[Dis_TCXScore],[Dis_Name],[Dis_Notes],[Dis_AppComments],[One_1],[One_2],[One_3],[One_1Note],[One_2Note],[One_3Note],[Two_1],[Two_1Note],[Three_1],[Three_2],[Three_3],[Three_4],[Three_5],[Three_6],[Three_7],[Three_1Note],[Three_2Note],[Three_3Note],[Three_4Note],[Three_5Note],[Three_6Note],[Three_7Note],[Four_1],[Four_2],[Four_3],[Four_1Note],[Four_2Note],[Four_3Note],[Five_1],[Five_2],[Five_1Note],[Five_2Note],[Six_1],[Six_1Note],[Seven_1],[Seven_2],[Seven_3],[Seven_1Note],[Seven_2Note],[Seven_3Note],[QAScore],[Autofail],[Auditor],[Supervisor],[Week_Number],[EditedQA],[TCX_Score],[1_1],[1_2],[1_3],[2_1],[3_1],[3_2],[3_3],[3_4],[3_5],[3_6],[3_7],[4_1],[4_2],[4_3],[5_1],[5_2],[6_1],[7_1],[7_2],[7_3],[Month],[DisputedQA],[PendingDisputeID],[SRType],[MainSupervisor],[CSATScore],[CSATQ1],[CSATQ2],[CSATQ3],[CSATQ4],[CSATQ5],[CSATQ6],[CallerType],[Dis_Approval])  Values (@ContactID,@EMID,@RegID,@AHT, @CType, @QA_Agent, @QA_Team, @QA_ContactDate, @QA_OrderID, @QA_Date, @QA_Comments, @QA_Opp, @CI_Name, @CI_Account, @CI_Company, @CI_Phone, @CI_Email, @Rev_Date, @Rev_Manager, @Rev_Comments, @Dis_Score,@Dis_TCXScore, @Dis_Name, @Dis_Notes, @Dis_AppComments, @One_1, @One_2, @One_3, @One_1Note, @One_2Note, @One_3Note, @Two_1, @Two_1Note, @Three_1, @Three_2, @Three_3, @Three_4, @Three_5, @Three_6, @Three_7,@Three_1Note, @Three_2Note, @Three_3Note, @Three_4Note, @Three_5Note, @Three_6Note, @Three_7Note, @Four_1, @Four_2, @Four_3, @Four_1Note, @Four_2Note, @Four_3Note, @Five_1, @Five_2, @Five_1Note, @Five_2Note, @Six_1,@Six_1Note, @Seven_1, @Seven_2, @Seven_3, @Seven_1Note, @Seven_2Note, @Seven_3Note,@QAScore, @Autofail, @Auditor, @Supervisor, @Week_Number, @EditedQA, @TCX_Score,@1_1,@1_2,@1_3,@2_1,@3_1,@3_2,@3_3,@3_4,@3_5,@3_6,@3_7,@4_1,@4_2,@4_3,@5_1,@5_2,@6_1,@7_1,@7_2,@7_3,@Month,@DisputedQA,@PendingDisputeID,@SRType,@MainSupervisor,@CSATScore,@CSATQ1,@CSATQ2,@CSATQ3,@CSATQ4,@CSATQ5,@CSATQ6,@CallerType,@Dis_Approval)"
            ...
            Using cmd As New SqlCommand(SQL, con)
                ...
                cmd.Parameters.AddWithValue("@1_1", txt1_1b.Text)
                cmd.Parameters.AddWithValue("@1_2", txt1_2b.Text)
                cmd.Parameters.AddWithValue("@1_3", txt1_3b.Text)


                cmd.Parameters.AddWithValue("@2_1", txt2_1b.Text)

                cmd.Parameters.AddWithValue("@3_1", txt3_1b.Text)
                cmd.Parameters.AddWithValue("@3_2", txt3_2b.Text)
                cmd.Parameters.AddWithValue("@3_3", txt3_3b.Text)
                cmd.Parameters.AddWithValue("@3_4", txt3_4b.Text)
                cmd.Parameters.AddWithValue("@3_5", txt3_5b.Text)
                cmd.Parameters.AddWithValue("@3_6", txt3_6b.Text)
                cmd.Parameters.AddWithValue("@3_7", txt3_7b.Text)


                cmd.Parameters.AddWithValue("@4_1", txt4_1b.Text)
                cmd.Parameters.AddWithValue("@4_2", txt4_2b.Text)
                cmd.Parameters.AddWithValue("@4_3", txt4_3b.Text)

                cmd.Parameters.AddWithValue("@5_1", txt5_1b.Text)
                cmd.Parameters.AddWithValue("@5_2", txt5_2b.Text)

                cmd.Parameters.AddWithValue("@6_1", txt6_1b.Text)



                cmd.Parameters.AddWithValue("@7_1", txt7_1b.Text)
                cmd.Parameters.AddWithValue("@7_2", txt7_2b.Text)
                cmd.Parameters.AddWithValue("@7_3", txt7_3b.Text)
    ...
    Public Sub save4()
        ...
        Try
            ...
            Dim SQL As String = "INSERT INTO [QAMainDB] ([ContactID],[EMID],[RegID],[AHT],[CType],[QA_Agent],[QA_Team],[QA_ContactDate],[QA_OrderID],[QA_Date],[QA_Comments],[QA_Opp],[CI_Name],[CI_Account],[CI_Company],[CI_Phone],[CI_Email],[Rev_Date],[Rev_Manager],[Rev_Comments],[Dis_TCXScore],[Dis_Score],[Dis_Name],[Dis_Notes],[Dis_AppComments],[One_1],[One_2],[One_3],[One_1Note],[One_2Note],[One_3Note],[Two_1],[Two_1Note],[Three_1],[Three_2],[Three_3],[Three_4],[Three_5],[Three_6],[Three_7],[Three_1Note],[Three_2Note],[Three_3Note],[Three_4Note],[Three_5Note],[Three_6Note],[Three_7Note],[Four_1],[Four_2],[Four_3],[Four_1Note],[Four_2Note],[Four_3Note],[Five_1],[Five_2],[Five_1Note],[Five_2Note],[Six_1],[Six_1Note],[Seven_1],[Seven_2],[Seven_3],[Seven_1Note],[Seven_2Note],[Seven_3Note],[QAScore],[Autofail],[Auditor],[Supervisor],[Week_Number],[EditedQA],[TCX_Score],[1_1],[1_2],[1_3],[2_1],[3_1],[3_2],[3_3],[3_4],[3_5],[3_6],[3_7],[4_1],[4_2],[4_3],[5_1],[5_2],[6_1],[7_1],[7_2],[7_3],[Month],[DisputedQA],[PendingDisputeID],[SRType],[MainSupervisor],[CSATScore],[CSATQ1],[CSATQ2],[CSATQ3],[CSATQ4],[CSATQ5],[CSATQ6],[CallerType],[Dis_Approval])  Values (@ContactID,@EMID,@RegID,@AHT, @CType, @QA_Agent, @QA_Team, @QA_ContactDate, @QA_OrderID, @QA_Date, @QA_Comments, @QA_Opp, @CI_Name, @CI_Account, @CI_Company, @CI_Phone, @CI_Email, @Rev_Date, @Rev_Manager, @Rev_Comments, @Dis_Score, @Dis_TCXScore, @Dis_Name, @Dis_Notes, @Dis_AppComments, @One_1, @One_2, @One_3, @One_1Note, @One_2Note, @One_3Note, @Two_1, @Two_1Note, @Three_1, @Three_2, @Three_3, @Three_4, @Three_5, @Three_6, @Three_7,@Three_1Note, @Three_2Note, @Three_3Note, @Three_4Note, @Three_5Note, @Three_6Note, @Three_7Note, @Four_1, @Four_2, @Four_3, @Four_1Note, @Four_2Note, @Four_3Note, @Five_1, @Five_2, @Five_1Note, @Five_2Note, @Six_1,@Six_1Note, @Seven_1, @Seven_2, @Seven_3, @Seven_1Note, @Seven_2Note, @Seven_3Note,@QAScore, @Autofail, @Auditor, @Supervisor, @Week_Number, @EditedQA, @TCX_Score,@1_1,@1_2,@1_3,@2_1,@3_1,@3_2,@3_3,@3_4,@3_5,@3_6,@3_7,@4_1,@4_2,@4_3,@5_1,@5_2,@6_1,@7_1,@7_2,@7_3,@Month,@DisputedQA,@PendingDisputeID,@SRType,@MainSupervisor,@CSATScore,@CSATQ1,@CSATQ2,@CSATQ3,@CSATQ4,@CSATQ5,@CSATQ6,@CallerType,@Dis_Approval)"
    ...
    Public Sub QAExcell()
        ...
        Try
            ...
            oSheet.Range("C35").Value = "" & txtCallerType.Text
            ...
            oSheet.Range("C62").Value = "" & dtpReviewdate.Text
            oSheet.Range("C61").Value = "" & txtSupervisor.Text
            oSheet.Range("B63").Value = txtRevComments.Text


            ''Dispute

            oSheet.Range("C71").Value = "" & txtDisputeScore.Text
            oSheet.Range("B73").Value = "" & txtDisputeNotes.Text
            oSheet.Range("C80").Value = "" & txtDisApp.Text
            oSheet.Range("B82").Value = "" & txtDisComment.Text
    ...
    Public Sub QAExcell2()
        ...
        Try
            ...
            '' Resouce
            Dim exeDir As New IO.FileInfo(Reflection.Assembly.GetExecutingAssembly.FullName)
            Dim xlpath = IO.Path.Combine(exeDir.DirectoryName, "WOTC Inbound.xlsx")
